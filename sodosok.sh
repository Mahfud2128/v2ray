...
cd /usr/bin
wget -O addss "http://juki.my.id/script/vpn/addss.sh"
wget -O delss "http://juki.my.id/script/vpn/delss.sh"
wget -O cekss "http://juki.my.id/script/vpn/cekss.sh"
wget -O expss "http://juki.my.id/script/vpn/expss.sh"
wget -O renewss "http://juki.my.id/script/vpn/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x expss
